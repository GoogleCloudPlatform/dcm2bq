...
jq \
  ...
  '.gcpConfig.projectId = $project_id | .gcpConfig.bigQuery.datasetId = $dataset_id | .gcpConfig.bigQuery.metadataTableId = $table_id | .gcpConfig.embeddings.gcsBucketPath = $gcs_bucket_path' \
